...
class StoreWithdrawTransactionExport implements FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    use Exportable;
    protected $data;
    ...
    {
        return view('file-exports.store-withdraw-transaction', [
            'data' => $this->data,
        ]);
    }
