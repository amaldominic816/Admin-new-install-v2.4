...
class CustomerWalletTransactionExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.customer-wallet-transaction', [
            'data' => $this->data,
        ]);
    }
