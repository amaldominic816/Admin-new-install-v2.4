...
class TransactionReportExport implements  FromView, ShouldAutoSize, WithStyles,WithColumnWidths ,WithHeadings, WithEvents
{
    ...
    public function styles(Worksheet $sheet) {
        ...
        $sheet->getStyle('A5:U5')->getFill()->applyFromArray([
            'fillType' => 'solid',
            'rotation' => 0,
            'color' => ['rgb' => '9F9F9F'],
        ]);
        ...
        return [
            ...
            'A1:U'.$this->data['order_transactions']->count() +5 => [
                'borders' => [
                    'allBorders' => [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A4:U'.$this->data['order_transactions']->count() +5)
                    ->getAlignment()
                    ->setHorizontal(Alignment::HORIZONTAL_CENTER)
                    ->setVertical(Alignment::VERTICAL_CENTER);
