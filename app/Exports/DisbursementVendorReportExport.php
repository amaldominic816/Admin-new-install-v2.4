...
class DisbursementVendorReportExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.disbursement-vendor-report', [
            'data' => $this->data,
        ]);
    }
