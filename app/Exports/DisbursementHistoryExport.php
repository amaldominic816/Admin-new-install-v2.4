...
class DisbursementHistoryExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.disbursement-history', [
            'data' => $this->data,
        ]);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A2:D'.$this->data['disbursements']->count() +2)
                    ->getAlignment()
