...
class StoreWiseWithdrawTransactionExport implements  FromView, ShouldAutoSize, WithStyles ,WithHeadings, WithEvents
{
    ...
    {
        return view('file-exports.store-wise-withdraw-transaction', [
            'data' => $this->data,
        ]);
    }
