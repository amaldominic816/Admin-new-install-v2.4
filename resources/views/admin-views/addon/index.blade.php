                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="store_id" id="store_id" class="js-data-example-ajax form-control"  data-placeholder="{{translate('messages.select_store')}}" oninvalid="this.setCustomValidity('{{translate('messages.please_select_store')}}')">
        ...
        <div class="card mt-1">
            <div class="card-header py-2 border-0">
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <div class="min--220">
                        <select name="store_id" id="store" onchange="set_store_filter('{{route('admin.addon.add-new')}}',this.value)" data-placeholder="{{translate('messages.select_store')}}" class="js-data-example-ajax form-control"   title="Select Restaurant">
                            @if(isset($store))
                    ...
                    <form class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input type="search" name="search" value="{{ request()->search ?? null }}" class="form-control min-height-45" placeholder="{{translate('messages.ex_:_addons_name')}}" aria-label="Search addons">
